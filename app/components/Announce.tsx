...
export const Announce = ({ announceType, title, body, updatedAt }: AnnounceProps) => {
    return (<>
      <div className={styles.announceTitleContainer}>
        <div className={styles.announceTitle}>
          <Tooltip content={t(announceType === "warn" ? "announce.warn" : "announce.info")}>
            <Text as="span">️{announceType === "warn" ? <ExclamationTriangleIcon /> : <InfoCircledIcon/>}</Text>
          </Tooltip>
