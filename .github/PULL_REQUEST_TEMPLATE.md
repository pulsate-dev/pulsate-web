...
Explain the motivation behind this PR and change.
It is better to explain in detail and have a clear reason.

You can use keyword "Fixes #issue-number" to close issue automatically.
